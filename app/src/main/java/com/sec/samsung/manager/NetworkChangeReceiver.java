...
public class NetworkChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NetworkInfo lan = cm.getNetworkInfo(ConnectivityManager.TYPE_ETHERNET);
        ...
        Debug.logI("nwConnected = " + nwConnected);
        Intent i = new Intent(Define.CHECK_NETWORK_CONN);
        i.putExtra(Define.DATA_CONN, nwConnected);
