...
public class MediaPlayerActivity extends BaseActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mFiles == null || mLen == 0) {
            ...
            Debug.logW("Folder " + mFolderMedia + " does not contain any photos");
            Utils.sendScheduledResponse2Server(this, file_id, schedule_id, false);
            finish();
            return;
        }

        photosList = new ArrayList<>(mLen);
        mediaList = new ArrayList<>(mLen);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        setVisibility(f);
        Debug.log("Created media player for " + getFilePlaying());
    }
    ...
    protected void onPause() {
        super.onPause();
        Debug.log("Pause media " + getFilePlaying());
        if (mediaPlayer != null && mediaPlayer.isPlaying()) {
            mediaPlayer.pause();
        }
